  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex-1 flex flex-col min-h-0 min-w-0 max-w-full overflow-x-hidden">
        ...
        <header className="sticky top-0 z-[2100] bg-white border-b border-gray-200 shadow-sm
            ...
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="mt-0.5 text-xs sm:text-sm text-gray-400 dark:text-gray-500 line-clamp-1">
                  {
                    pathname === "/authority" ? "Overview of department complaints, performance metrics, and recent activity." :
                      pathname.startsWith("/authority/track") ? "Monitor and manage complaints across the city through the live complaint map." :
                        pathname.startsWith("/authority/workers") ? "View and manage department field workers and their availability status." :
                          pathname.startsWith("/authority/reports") ? "Analyze complaint trends, resolution performance, and SLA compliance." :
                            ""
                  }
                </p>
              </div>
