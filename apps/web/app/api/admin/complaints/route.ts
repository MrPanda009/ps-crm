...
export async function GET(req: NextRequest) {
  ...
  let query = supabase
    .from("complaints")
    .select(
      "id, ticket_id, title, category_id, address_text, ward_name, city, status, severity, escalation_level, created_at, assigned_department, assigned_worker_id, assigned_officer_id, citizen_id, categories(name)",
      { count: "exact" },
    )
